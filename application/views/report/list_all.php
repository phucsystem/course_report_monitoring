                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php foreach ($reports as $report){ ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <?php }?>
                                            <button type="button" data-toggle="tooltip" data-placement="top" title="Edit" class="btn btn-primary btn-circle" onclick="location.href = '<?php echo site_url('report/edit') .'/'. $report['id']?>';"><i class="fa fa-pencil"></i>
                          					 </button>
					                         <button type="button" data-toggle="tooltip" data-placement="top" title="Delete" class="btn btn-warning btn-circle" onclick='deleteItem(<?php echo $report['id'] ?>)'><i class="fa fa-trash-o"></i>
                          					 ...
                          					 <button type="button" data-toggle="tooltip" data-placement="top" title="Approve" class="btn btn-info btn-circle"><i class="fa fa-check"></i>
                          					 </button>
