        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Create academic year form</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-6">
                    <div class="panel panel-default">
                       ...
                       <div class="alert alert-danger alert-dismissable">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
								<?php echo form_open('year/create', ['class' => 'validate-form'])?>                                        
										<div class="form-group">
                                            <label>Year</label>
                                            <input class="form-control validate[required, custom[number]]" name="year" >
                                        </div>
                                        	<div class="form-group">
                                              <label>Course</label>
